...
namespace Umbraco.Headless.Client.Net.Api.RedirectUrlManagement
{
    ...
    interface RedirectUrlManagementEndpoints
    {
        ...
        Task<RedirectUrlSearchResult> SearchRedirectUrls([Header(Constants.Headers.ProjectAlias)] string projectAlias, [Header(Constants.Headers.AcceptLanguage)] string searchTerm, int page, int pageSize);
